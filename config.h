...
static const char *fonts[]          = { "Noto Sans Display:size=11" };
...
static Key keys[] = {
	...
	/* Media keys */
	{ 0,           XF86XK_AudioRaiseVolume,      spawn,          SHCMD("pamixer --allow-boost --increase 1; okki-status --refresh=volume") },
	{ 0,           XF86XK_AudioLowerVolume,      spawn,          SHCMD("pamixer --allow-boost --decrease 1; okki-status --refresh=volume") },
	{ ShiftMask,   XF86XK_AudioRaiseVolume,      spawn,          SHCMD("pamixer --allow-boost --increase 10; okki-status --refresh=volume") },
	{ ShiftMask,   XF86XK_AudioLowerVolume,      spawn,          SHCMD("pamixer --allow-boost --decrease 10; okki-status --refresh=volume") },
